...
import { numbers20to100 } from "../../shared/data/data";
...
const ThaiNumbers20to100: React.FC = () => {
  return (
    <div className="mx-4">
      <div className="p-4 my-6 max-w-3xl mx-auto bg-white rounded shadow-md mx-4">
        <table className="w-full table-auto border-collapse border border-gray-300">
          ...
          <tbody>
            {numbers20to100.map(({ num, thaiNum, thaiText, eng }) => (
