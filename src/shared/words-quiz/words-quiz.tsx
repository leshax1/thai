...
const WordsQuiz: React.FC<WordQuizProps> = ({ data }) => {
  ...
  return (
    <div className="p-4 sm:p-6 my-6 max-w-xl mx-auto bg-white rounded shadow-md text-center">
      ...
      <button
        ...
        className="mt-2 text-xs sm:text-sm text-blue-600 hover:underline cursor-pointer"
      ...
      <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
        {choices.map((choice) => (
          <button
            key={choice.english}
            onClick={() => handleChoice(choice.english)}
